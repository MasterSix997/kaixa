...
namespace kaixa {
    ...
    public:
        ...
        [[nodiscard]] const LocalPackageCandidate* find_for(const std::filesystem::path& requester_manifest, std::string_view name) const;
        [[nodiscard]] const LocalPackageCandidate* find_in_set(
    ...
    private:
        ...
        [[nodiscard]] Result<std::size_t> index_scope(const std::filesystem::path& manifest, std::optional<std::size_t> parent);
